...
const Slide = ({ imagesQuery, content, onClick, active, index, sliderName }) => {
	...
	return isMediaOfTypeImage ?
		<SlideImageComponent sliderName={sliderName} active={active} onClick={onClick} imagesQuery={imagesQuery} content={content} /> :
		<SlideVideoComponent sliderName={sliderName} index={index} active={active} onClick={onClick} content={content} /> ;
};
