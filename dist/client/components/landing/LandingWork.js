...
/*#__PURE__*/
function (_Component) {
  _inherits(LandingWork, _Component);

  function LandingWork() {
    _classCallCheck(this, LandingWork);

    return _possibleConstructorReturn(this, _getPrototypeOf(LandingWork).apply(this, arguments));
  }

  _createClass(LandingWork, [{
    key: "render",
    value: function render() {
      return _react.default.createElement(_InfinitScroll.default, {
        ...
        render: function render(visibleContent) {
          return visibleContent.map(function (post) {
