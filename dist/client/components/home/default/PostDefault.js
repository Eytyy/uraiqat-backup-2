...
var PostDefault = function (_Component) {
	_inherits(PostDefault, _Component);

	function PostDefault() {
		_classCallCheck(this, PostDefault);

		return _possibleConstructorReturn(this, (PostDefault.__proto__ || Object.getPrototypeOf(PostDefault)).apply(this, arguments));
	}

	_createClass(PostDefault, [{
		key: 'render',
