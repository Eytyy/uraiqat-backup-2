...
function (_Component) {
  ...
  function PostMediaImage() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(PostMediaImage).apply(this, arguments));
  }
  ...
  _createClass(PostMediaImage, [{
    ...
    value: function render() {
      ...
      var imgSrc = query ? "".concat(content.fields.file.url, "?").concat(query) : content.fields.file.url;
      return _react.default.createElement(_ImageComponent.default, {
        patternId: "".concat(patternId, "--").concat(orientation),
