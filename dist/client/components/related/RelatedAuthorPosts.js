...
function (_Component) {
  ...
  function RelatedAuthorPosts() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(RelatedAuthorPosts).apply(this, arguments));
  }
  ...
  _createClass(RelatedAuthorPosts, [{
    ...
    value: function fetchData() {
      var _this$props2 = this.props,
          fetchAuthorRelated = _this$props2.fetchAuthorRelated,
...
RelatedAuthorPosts.propTypes = {
  ...
  fetchAuthorRelated: _propTypes.default.func.isRequired
};
RelatedAuthorPosts.defaultProps = {
  content: []
};

var _default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, actions)(RelatedAuthorPosts));
