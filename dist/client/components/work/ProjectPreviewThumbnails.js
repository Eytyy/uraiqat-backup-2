	...
	if (orientation === 'landscape') {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				main && _react2.default.createElement(_ImageComponent2.default, { imagesQuery: '?fl=progressive&w=700', classList: 'project-preview__image project-preview__image--main', src: main.fields.file.url })
			),
			_react2.default.createElement(
				'div',
				...
				diagram && _react2.default.createElement(_ImageComponent2.default, { imagesQuery: '?fl=progressive&w=322', classList: 'project-preview__image project-preview__image--diagram', src: diagram.fields.file.url }),
				craft && _react2.default.createElement(_ImageComponent2.default, { imagesQuery: '?fl=progressive&w=322', classList: 'project-preview__image project-preview__image--craft', src: craft.fields.file.url })
			)
		);
	}
	return _react2.default.createElement(
