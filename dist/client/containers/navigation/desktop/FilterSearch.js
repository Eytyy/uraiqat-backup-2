...
var _FilterSearchFilter = require('./FilterSearchFilter');

var _FilterSearchFilter2 = _interopRequireDefault(_FilterSearchFilter);

var _FilterSearchSearch = require('./FilterSearchSearch');

var _FilterSearchSearch2 = _interopRequireDefault(_FilterSearchSearch);
	...
	_createClass(FilterSearch, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				reservedFilterSize === 0 ? null : _react2.default.createElement(_FilterSearchFilter2.default, {
					filtersAreVisible: this.state.filtersAreVisible,
					onfiltersClick: this.onfiltersClick,
					config: config.filter
				}),
				_react2.default.createElement(_FilterSearchSearch2.default, {
					searchIsVisible: this.state.searchIsVisible,
