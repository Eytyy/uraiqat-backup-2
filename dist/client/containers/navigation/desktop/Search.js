...
var FilterSearchSearch =
/*#__PURE__*/
function (_Component) {
  _inherits(FilterSearchSearch, _Component);

  function FilterSearchSearch() {
    _classCallCheck(this, FilterSearchSearch);

    return _possibleConstructorReturn(this, _getPrototypeOf(FilterSearchSearch).apply(this, arguments));
  }

  _createClass(FilterSearchSearch, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          config = _this$props.config,
          searchIsVisible = _this$props.searchIsVisible,
      ...
      return _react.default.createElement("span", {
        className: "search ".concat(searchIsVisible ? 'is-visible' : 'is-hidden')
      ...
      }, config.name), _react.default.createElement("span", {
        ...
        fixed: config.searchInputSize
      }));
    }
  }]);

  return FilterSearchSearch;
}(_react.Component);

var _default = FilterSearchSearch;
